...
for (let index = 0; index < quantityObstacle; index++) {
    obstacle.setPosition(getRandomArbitrary(0, dimensionY - 1), getRandomArbitrary(1, dimensionX - 1))
...
for (let index = 0; index < quantityItems; index++) {
    item.setPosition(getRandomArbitrary(1, dimensionY - 2), getRandomArbitrary(1, dimensionX - 2))
...
for (let index = 0; index <= items.length - 1; index++) {
    it = items[index]
    if (maze[it.posicion.y][it.posicion.x] !== '[#]') {
